        ...
        return (
            <form className="dataInput wrapper" onSubmit={(event) => getInput(event, setInputConfirmation)}>
                ...
                <div className="input--diastolic">
                    ...
                    <input type="number" min="0" max="180" name="diastolic" id="diastolic" placeholder="70" onChange={(event) => handleInputChange(event, heartData, setHeartData, 2)}/>
                    <p>mmHg</p>
                </div>

                <div className="input--heartRate">
                    <label htmlFor="heartRate">{ language.heartRate }:</label>
                    <input type="number" min="0" max="180" name="heartRate" id="heartRate" placeholder="65" onChange={(event) => handleInputChange(event, heartData, setHeartData, 3)}/>
                    <p>bpm</p>
                </div>
                ...
                <div className="input--bloodSugar">
                    ...
                    <input  type="number" 
                            step="0.1" min="0" max={ bloodSugarUnit === 'mmol/L' ? '15' : '270' } 
                            name="bloodSugar" id="bloodSugar" placeholder={ bloodSugarUnit === 'mmol/L' ? 5.5 : 5.5*18 } 
                            onChange={(event) => handleInputChange(event, heartData, setHeartData, 4)}
                    />
